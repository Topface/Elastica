...
use Elastica6\Bulk\Action\CreateDocument;
use Elastica6\Bulk\Action\IndexDocument;
use Elastica6\Bulk\Action\UpdateDocument;
use Elastica6\Bulk\Response;
use Elastica6\Bulk\ResponseSet;
use Elastica6\Document;
use Elastica6\Exception\Bulk\ResponseException;
use Elastica6\Exception\NotFoundException;
