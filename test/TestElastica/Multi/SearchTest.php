<?php
namespace TestElastica\Test\Multi;

use TestElastica\Document;
use TestElastica\Multi\ResultSet as MultiResultSet;
use TestElastica\Multi\Search as MultiSearch;
