...
use TestElastica\Exception\RuntimeException;
...
class Type implements SearchableInterface
{
     ...
     *
     * @param \TestElastica\Document $doc Document with data
     *
     ...
     *
     * @param \TestElastica\Document|\TestElastica\Script\AbstractScript $data    Document with update data
     ...
     *
     * @param \TestElastica\Type\Mapping|array $mapping TestElastica\Type\MappingType object or property array with all mappings
     ...
     *
     * @param \TestElastica\Query|string $query   Query object
     ...
     *
     * @see \TestElastica\Type::addObject
     *
     * @param array|string $serializer @see \TestElastica\Type::_serializer
     *
     * @return $this
     */
