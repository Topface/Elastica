...
class Client
{
     ...
     * retryOnConflict: Use in \TestElastica\Client::updateDocument
    ...
    /**
     * @var \TestElastica\Request|null
     */
    protected $_lastRequest;

    /**
     * @var \TestElastica\Response|null
     */
    ...
    /**
     * Creates a new TestElastica client.
     *
     ...
     *
     * @return \TestElastica\Index Index for the given name
     */
     ...
     *
     * @throws \TestElastica\Exception\InvalidException If $header or $headerValue is not a string
     *
     * @return $this
     */
     ...
     *
     * @throws \TestElastica\Exception\InvalidException If $header is not a string
     *
     * @return $this
     */
     ...
     *
     * Array of \TestElastica\Document as input. Index and type has to be
     * set inside the document, because for bulk settings documents,
     * documents can belong to any type and index
     *
     * @link https://www.elastic.co/guide/en/elasticsearch/reference/current/docs-bulk.html
     *
     * @param array|\TestElastica\Document[] $docs Array of TestElastica\Document
     * @param array                          $requestParams
     *
     * @throws \TestElastica\Exception\InvalidException If docs is empty
     *
     * @return \TestElastica\Bulk\ResponseSet Response object
     */
     ...
     * @param array|\TestElastica\Script\AbstractScript|\TestElastica\Document $data    raw data for request body
     * @param string                                                           $index   index to update
     * @param string                                                           $type    type of index to update
     * @param array                                                            $options array of query params to use for query. For possible options check es api
     *
     * @return \TestElastica\Response
     *
     ...
     *
     * @param array|\TestElastica\Document[] $docs
     * @param array                          $requestParams
     *
     * @throws \TestElastica\Exception\InvalidException
     *
     * @return \TestElastica\Bulk\ResponseSet
     */
     ...
     *
     * @return \TestElastica\Status Status object
     */
     ...
     *
     * @return \TestElastica\Cluster Cluster object
     */
     ...
     * @param string|\TestElastica\Index $index   Index name
     * @param string|\TestElastica\Type  $type    Type of documents
     ...
     *
     * @throws \TestElastica\Exception\ResponseException
     * @throws \TestElastica\Exception\InvalidException
     *
     * @return \TestElastica\Bulk\ResponseSet Response object
     */
    ...
    protected function _log($context)
    {
        if ($context instanceof ConnectionException) {
            $this->_logger->error('TestElastica Request Failure', [
                'exception' => $context,
        ...
        if ($context instanceof Request) {
            $this->_logger->debug('TestElastica Request', [
    ...
    {
        trigger_error('Deprecated: TestElastica\Client::optimizeAll() is deprecated and will be removed in further Elastica releases. Use Elastica\Client::forcemergeAll() instead.', E_USER_DEPRECATED);
