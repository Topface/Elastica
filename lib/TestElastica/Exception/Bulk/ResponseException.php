<?php
namespace TestElastica\Exception\Bulk;

use TestElastica\Bulk\ResponseSet;
use TestElastica\Exception\Bulk\Response\ActionException;
use TestElastica\Exception\BulkException;
...
{
    /**
     * @var \TestElastica\Bulk\ResponseSet ResponseSet object
     */
    protected $_responseSet;

    /**
     * @var \TestElastica\Exception\Bulk\Response\ActionException[]
     */
     ...
     * Construct Exception.
     *
     * @param \TestElastica\Bulk\ResponseSet $responseSet
     */
    ...
    /**
     * @return \TestElastica\Exception\Bulk\Response\ActionException[]
     */
