...
trigger_error('TestElastica\Exception\ElasticsearchException is deprecated. Use TestElastica\Exception\ResponseException::getResponse::getFullError instead.', E_USER_DEPRECATED);
