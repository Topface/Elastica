...
use TestElastica\Aggregation\Avg;
use TestElastica\Aggregation\AvgBucket;
use TestElastica\Aggregation\BucketScript;
use TestElastica\Aggregation\Cardinality;
use TestElastica\Aggregation\DateHistogram;
use TestElastica\Aggregation\DateRange;
use TestElastica\Aggregation\ExtendedStats;
use TestElastica\Aggregation\Filter as FilterAggregation;
use TestElastica\Aggregation\Filters;
use TestElastica\Aggregation\GeoDistance;
use TestElastica\Aggregation\GeohashGrid;
use TestElastica\Aggregation\GlobalAggregation;
use TestElastica\Aggregation\Histogram;
use TestElastica\Aggregation\IpRange;
use TestElastica\Aggregation\Max;
use TestElastica\Aggregation\Min;
use TestElastica\Aggregation\Missing;
use TestElastica\Aggregation\Nested;
use TestElastica\Aggregation\Percentiles;
use TestElastica\Aggregation\Range;
use TestElastica\Aggregation\ReverseNested;
use TestElastica\Aggregation\ScriptedMetric;
use TestElastica\Aggregation\SerialDiff;
use TestElastica\Aggregation\SignificantTerms;
use TestElastica\Aggregation\Stats;
use TestElastica\Aggregation\Sum;
use TestElastica\Aggregation\SumBucket;
use TestElastica\Aggregation\Terms;
use TestElastica\Aggregation\TopHits;
use TestElastica\Aggregation\ValueCount;
use TestElastica\Exception\NotImplementedException;
use TestElastica\Query\AbstractQuery;
