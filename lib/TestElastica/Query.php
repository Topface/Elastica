...
use TestElastica\Aggregation\AbstractAggregation;
...
use TestElastica\Script\ScriptFields;
use TestElastica\Suggest\AbstractSuggest;

/**
 * TestElastica query object.
 *
...
class Query extends Param
{
     ...
     *
     * @param array|\TestElastica\Query\AbstractQuery $query OPTIONAL Query object (default = null)
     */
     ...
     *
     * For example, an empty argument will return a \TestElastica\Query with a \TestElastica\Query\MatchAll.
     *
     * @param mixed $query
     *
     ...
     * Sets the query.
     *
     * @param \TestElastica\Query\AbstractQuery $query Query object
     *
     * @return $this
     */
     ...
     *
     * @return \TestElastica\Query\AbstractQuery
     **/
     ...
     * Set script fields.
     *
     * @param array|\TestElastica\Script\ScriptFields $scriptFields Script fields
     *
     * @return $this
     *
     ...
     *
     * @param string                              $name
     * @param \TestElastica\Script\AbstractScript $script Script object
     *
     * @return $this
     */
     ...
     * Add a suggest term.
     *
     * @param \TestElastica\Suggest $suggest suggestion object
     *
     * @return $this
     */
     ...
     *
     * @param array|\TestElastica\Query\AbstractQuery $filter
     *
     * @return $this
     *
