<?php
namespace TestElastica\Transport;

use TestElastica\Connection;
use TestElastica\Exception\Connection\GuzzleException;
use TestElastica\Exception\PartialShardFailureException;
...
/**
 * TestElastica Guzzle Transport object.
 *
...
class Guzzle extends AbstractTransport
{
     ...
     *
     * @throws \TestElastica\Exception\ConnectionException
     * @throws \TestElastica\Exception\ResponseException
     * @throws \TestElastica\Exception\Connection\HttpException
     *
     ...
     * @param Request $request    TestElastica Request Object
     *
     * @return Client
     */
