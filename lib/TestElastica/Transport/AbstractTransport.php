...
/**
 * TestElastica Abstract Transport object.
 *
...
abstract class AbstractTransport extends Param
{
     ...
     * Construct transport.
     *
     * @param \TestElastica\Connection $connection Connection object
     */
    ...
    /**
     * @return \TestElastica\Connection Connection object
     */
     ...
     *
     * @param \TestElastica\Request $request Request object
     ...
     * @param \TestElastica\Connection $connection A connection instance
    ...
    public static function create($transport, Connection $connection, array $params = [])
    {
        ...
        if (is_string($transport)) {
            ...
            $classNames = ["TestElastica\\Transport\\$transport", $transport];
