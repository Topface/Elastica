<?php
namespace TestElastica\Rescore;

use TestElastica\Query as BaseQuery;
...
class Query extends AbstractRescore
{
     ...
     * Constructor.
     *
     * @param string|\TestElastica\Query\AbstractQuery $query
     */
     ...
     *
     * @param string|\TestElastica\Query|\TestElastica\Query\AbstractQuery $rescoreQuery
     *
     * @return $this
     */
