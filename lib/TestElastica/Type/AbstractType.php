<?php
namespace TestElastica\Type;

use TestElastica\Client;
use TestElastica\Exception\InvalidException;
use TestElastica\Index;
use TestElastica\SearchableInterface;
use TestElastica\Type as BaseType;
...
abstract class AbstractType implements SearchableInterface
{
     ...
     * Type.
     *
     * @var \TestElastica\Type Type object
     */
    protected $_type;
     ...
     *
     * @param \TestElastica\Client $client OPTIONAL Client object
     *
    ...
    /**
     * @param string|\TestElastica\Query $query
