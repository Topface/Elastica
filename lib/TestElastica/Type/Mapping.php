...
class Mapping
{
     ...
     * Construct Mapping.
     *
     * @param \TestElastica\Type $type       OPTIONAL Type object
     ...
     *
     * @param \TestElastica\Type $type Type object
     *
     * @return $this
     */
     ...
     *
     * @param array|\TestElastica\Type\Mapping $mapping Mapping object or properties array
     *
     * @throws \TestElastica\Exception\InvalidException If invalid type
     *
     * @return self
     */
