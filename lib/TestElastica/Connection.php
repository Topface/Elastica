...
/**
 * TestElastica connection instance to an elasticasearch node.
 *
...
class Connection extends Param
{
     ...
     *
     * @throws \TestElastica\Exception\InvalidException If invalid transport type
     *
     * @return \TestElastica\Transport\AbstractTransport Transport object
     */
    ...
    /**
     * @param \TestElastica\Connection|array $params Params to create a connection
     *
