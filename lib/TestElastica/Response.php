...
use TestElastica\Exception\JSONParseException;
use TestElastica\Exception\NotFoundException;

/**
 * TestElastica Response object.
 *
...
class Response
{
     ...
     * from the \TestElastica\Client::_callService .
     *
     ...
     * Time request took.
     *
     * @throws \TestElastica\Exception\NotFoundException
     *
