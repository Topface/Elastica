...
use TestElastica\ResultSet as BaseResultSet;

/**
 * TestElastica multi search result set
...
class ResultSet implements \Iterator, \ArrayAccess, \Countable
{
     ...
     * Result Sets.
     *
     * @var array|\TestElastica\ResultSet[] Result Sets
     */
    ...
    /**
     * @return array|\TestElastica\ResultSet[]
     */
    ...
    /**
     * @return bool|\TestElastica\ResultSet
     */
