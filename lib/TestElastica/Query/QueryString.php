...
class QueryString extends AbstractQuery
{
     ...
     *
     * @throws \TestElastica\Exception\InvalidException If given parameter is not a string
     *
     * @return $this
     */
     ...
     *
     * @throws \TestElastica\Exception\InvalidException If given parameter is not an array
     *
     * @return $this
     */
     ...
     *
     * @see \TestElastica\Query\AbstractQuery::toArray()
     *
