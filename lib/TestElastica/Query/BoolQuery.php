...
class BoolQuery extends AbstractQuery
{
     ...
     *
     * @param \TestElastica\Query\AbstractQuery|array $args Should query
     *
     * @return $this
     */
     ...
     *
     * @param \TestElastica\Query\AbstractQuery|array $args Must query
     *
     * @return $this
     */
     ...
     *
     * @param \TestElastica\Query\AbstractQuery|array $args Must not query
     *
     * @return $this
     */
     ...
     * Sets the filter.
     *
     * @param \TestElastica\Query\AbstractQuery $filter Filter object
     *
     * @return $this
     */
    ...
    protected function _addQuery($type, $args)
    {
        if (!is_array($args) && !($args instanceof AbstractQuery)) {
            throw new InvalidException('Invalid parameter. Has to be array or instance of TestElastica\Query\AbstractQuery');
        }
