...
use Elastica6\Bulk\Action\AbstractDocument as AbstractDocumentAction;
use Elastica6\Bulk\Response as BulkResponse;
use Elastica6\Bulk\ResponseSet;
use Elastica6\Exception\Bulk\ResponseException as BulkResponseException;
...
class Bulk
{
    ...
    /**
     * @param string|\Elastica6\Index $index
     *
     * @return $this
     */
    ...
    /**
     * @param string|\Elastica6\Type $type
     *
     * @return $this
     */
    ...
    /**
     * @param \Elastica6\Bulk\Action[] $actions
     *
     * @return $this
     */
    ...
    /**
     * @param \Elastica6\Document[] $documents
     * @param string                   $opType
     *
     * @return $this
     */
    ...
    /**
     * @param \Elastica6\Document[] $scripts
     * @param string                   $opType
     *
     * @return $this
     */
    ...
    /**
     * @param \Elastica6\Script\AbstractScript|\Elastica6\Document|array $data
     * @param string                                                           $opType
     *
     * @return $this
     */
     ...
     *
     * @throws \Elastica6\Exception\Bulk\ResponseException
     * @throws \Elastica6\Exception\InvalidException
     *
     * @return \Elastica6\Bulk\ResponseSet
     */
