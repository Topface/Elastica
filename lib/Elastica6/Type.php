...
use Elastica6\Exception\RuntimeException;
...
class Type implements SearchableInterface
{
     ...
     *
     * @param \Elastica6\Document $doc Document with data
     *
     ...
     *
     * @param \Elastica6\Document|\Elastica6\Script\AbstractScript $data    Document with update data
     ...
     *
     * @param \Elastica6\Type\Mapping|array $mapping Elastica6\Type\MappingType object or property array with all mappings
     ...
     *
     * @param \Elastica6\Query|string $query   Query object
     ...
     *
     * @see \Elastica6\Type::addObject
     *
     * @param array|string $serializer @see \Elastica6\Type::_serializer
     *
     * @return $this
     */
