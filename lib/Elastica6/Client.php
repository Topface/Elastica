...
class Client
{
     ...
     * retryOnConflict: Use in \Elastica6\Client::updateDocument
    ...
    /**
     * @var \Elastica6\Request|null
     */
    protected $_lastRequest;

    /**
     * @var \Elastica6\Response|null
     */
    ...
    /**
     * Creates a new Elastica6 client.
     *
     ...
     *
     * @return \Elastica6\Index Index for the given name
     */
     ...
     *
     * @throws \Elastica6\Exception\InvalidException If $header or $headerValue is not a string
     *
     * @return $this
     */
     ...
     *
     * @throws \Elastica6\Exception\InvalidException If $header is not a string
     *
     * @return $this
     */
     ...
     *
     * Array of \Elastica6\Document as input. Index and type has to be
     * set inside the document, because for bulk settings documents,
     * documents can belong to any type and index
     *
     * @link https://www.elastic.co/guide/en/elasticsearch/reference/current/docs-bulk.html
     *
     * @param array|\Elastica6\Document[] $docs Array of Elastica6\Document
     * @param array                          $requestParams
     *
     * @throws \Elastica6\Exception\InvalidException If docs is empty
     *
     * @return \Elastica6\Bulk\ResponseSet Response object
     */
     ...
     * @param array|\Elastica6\Script\AbstractScript|\Elastica6\Document $data    raw data for request body
     ...
     *
     * @param array|\Elastica6\Document[] $docs
     * @param array                          $requestParams
     *
     * @throws \Elastica6\Exception\InvalidException
     *
     ...
     *
     * @return \Elastica6\Status Status object
     */
     ...
     *
     * @return \Elastica6\Cluster Cluster object
     */
     ...
     * @param string|\Elastica6\Index $index   Index name
     * @param string|\Elastica6\Type  $type    Type of documents
     ...
     *
     * @throws \Elastica6\Exception\ResponseException
     * @throws \Elastica6\Exception\InvalidException
     *
     * @return \Elastica6\Bulk\ResponseSet Response object
     */
    ...
    protected function _log($context)
    {
        if ($context instanceof ConnectionException) {
            $this->_logger->error('Elastica6 Request Failure', [
                'exception' => $context,
        ...
        if ($context instanceof Request) {
            $this->_logger->debug('Elastica6 Request', [
    ...
    {
        trigger_error('Deprecated: Elastica6\Client::optimizeAll() is deprecated and will be removed in further Elastica releases. Use Elastica\Client::forcemergeAll() instead.', E_USER_DEPRECATED);
