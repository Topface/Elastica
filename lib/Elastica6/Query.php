...
use Elastica6\Aggregation\AbstractAggregation;
...
use Elastica6\Suggest\AbstractSuggest;

/**
 * Elastica6 query object.
 *
...
class Query extends Param
{
     ...
     *
     * @param array|\Elastica6\Query\AbstractQuery $query OPTIONAL Query object (default = null)
     */
     ...
     *
     * For example, an empty argument will return a \Elastica6\Query with a \Elastica6\Query\MatchAll.
     *
     * @param mixed $query
     *
     ...
     * Sets the query.
     *
     * @param \Elastica6\Query\AbstractQuery $query Query object
     *
     * @return $this
     */
     ...
     *
     * @return \Elastica6\Query\AbstractQuery
     **/
     ...
     * Set script fields.
     *
     * @param array|\Elastica6\Script\ScriptFields $scriptFields Script fields
     *
     * @return $this
     *
     ...
     *
     * @param string                              $name
     * @param \Elastica6\Script\AbstractScript $script Script object
     *
     * @return $this
     */
     ...
     * Add a suggest term.
     *
     * @param \Elastica6\Suggest $suggest suggestion object
     *
     * @return $this
     */
     ...
     *
     * @param array|\Elastica6\Query\AbstractQuery $filter
     *
     * @return $this
     *
