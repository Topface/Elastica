...
use Elastica6\Processor\AbstractProcessor;
...
class Pipeline extends Param
{
    ...
    public function create()
    {
        ...
        if (empty($this->_processors['processors'])) {
            throw new InvalidException('You should set a valid processor of type Elastica6\Processor\AbstractProcessor.');
        }
