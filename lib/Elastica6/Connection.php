...
/**
 * Elastica6 connection instance to an elasticasearch node.
 *
...
class Connection extends Param
{
     ...
     *
     * @throws \Elastica6\Exception\InvalidException If invalid transport type
     *
     * @return \Elastica6\Transport\AbstractTransport Transport object
     */
    ...
    /**
     * @param \Elastica6\Connection|array $params Params to create a connection
     *
