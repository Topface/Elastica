<?php
namespace Elastica6\Rescore;

use Elastica6\Query as BaseQuery;
...
class Query extends AbstractRescore
{
     ...
     * Constructor.
     *
     * @param string|\Elastica6\Query\AbstractQuery $query
     */
     ...
     *
     * @param string|\Elastica6\Query|\Elastica6\Query\AbstractQuery $rescoreQuery
     *
     * @return $this
     */
