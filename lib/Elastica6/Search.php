...
class Search
{
     ...
     *
     * @param \Elastica6\Index|string $index Index object or string
     *
     ...
     *
     * @param \Elastica6\Type|string $type Type name or object
     *
     * @throws \Elastica6\Exception\InvalidException
     *
     * @return $this
    ...
    /**
     * @param string|array|\Elastica6\Query|\Elastica6\Suggest|\Elastica6\Query\AbstractQuery $query
     *
     * @return $this
     */
    ...
    /**
     * @param \Elastica6\Type|string $type
     *
     * @return bool
     */
     ...
     *
     * @param \Elastica6\SearchableInterface $searchObject
     *
     * @return Search
     */
