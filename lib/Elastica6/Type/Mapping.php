...
class Mapping
{
     ...
     * Construct Mapping.
     *
     * @param \Elastica6\Type $type       OPTIONAL Type object
     ...
     *
     * @param \Elastica6\Type $type Type object
     *
     * @return $this
     */
     ...
     *
     * @param array|\Elastica6\Type\Mapping $mapping Mapping object or properties array
     *
     * @throws \Elastica6\Exception\InvalidException If invalid type
     *
     * @return self
     */
