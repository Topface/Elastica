...
/**
 * Elastica6 Abstract Transport object.
 *
...
abstract class AbstractTransport extends Param
{
     ...
     * Construct transport.
     *
     * @param \Elastica6\Connection $connection Connection object
     */
    ...
    /**
     * @return \Elastica6\Connection Connection object
     */
     ...
     *
     * @param \Elastica6\Request $request Request object
     ...
     * @param \Elastica6\Connection $connection A connection instance
    ...
    public static function create($transport, Connection $connection, array $params = [])
    {
        ...
        if (is_string($transport)) {
            ...
            $classNames = ["Elastica6\\Transport\\$transport", $transport];
