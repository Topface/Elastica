...
use Elastica6\Exception\Connection\GuzzleException;
...
/**
 * Elastica6 Guzzle Transport object.
 *
...
class Guzzle extends AbstractTransport
{
     ...
     *
     * @throws \Elastica6\Exception\ConnectionException
     * @throws \Elastica6\Exception\ResponseException
     * @throws \Elastica6\Exception\Connection\HttpException
     *
     ...
     * @param Request $request    Elastica6 Request Object
     *
     * @return Client
     */
