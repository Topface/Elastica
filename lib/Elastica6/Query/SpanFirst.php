...
class SpanFirst extends AbstractSpanQuery
{
     ...
     *
     * @param \Elastica6\Query\AbstractSpanQuery|array $args Matching query
     *
    ...
    protected function _setQuery($type, $args)
    {
        if (!is_array($args) && !($args instanceof AbstractSpanQuery)) {
            throw new InvalidException('Invalid parameter. Has to be array or instance of Elastica6\Query\AbstractSpanQuery');
        }
