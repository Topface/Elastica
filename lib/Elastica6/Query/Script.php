...
class Script extends AbstractQuery
{
     ...
     *
     * @param array|string|\Elastica6\Script\AbstractScript $script OPTIONAL Script
     */
     ...
     * Sets script object.
     *
     * @param \Elastica6\Script\Script|string|array $script
     *
     * @return $this
     */
    public function setScript($script)
    {
        return $this->setParam('script', Elastica6\Script\Script::create($script));
    }
