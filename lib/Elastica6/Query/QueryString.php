...
class QueryString extends AbstractQuery
{
     ...
     *
     * @throws \Elastica6\Exception\InvalidException If given parameter is not a string
     *
     * @return $this
     */
     ...
     *
     * @throws \Elastica6\Exception\InvalidException If given parameter is not an array
     *
     * @return $this
     */
     ...
     *
     * @see \Elastica6\Query\AbstractQuery::toArray()
     *
