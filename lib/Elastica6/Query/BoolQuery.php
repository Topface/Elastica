...
class BoolQuery extends AbstractQuery
{
     ...
     *
     * @param \Elastica6\Query\AbstractQuery|array $args Should query
     *
     * @return $this
     */
     ...
     *
     * @param \Elastica6\Query\AbstractQuery|array $args Must query
     *
     * @return $this
     */
     ...
     *
     * @param \Elastica6\Query\AbstractQuery|array $args Must not query
     *
     * @return $this
     */
     ...
     * Sets the filter.
     *
     * @param \Elastica6\Query\AbstractQuery $filter Filter object
     *
     * @return $this
     */
