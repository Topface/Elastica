<?php
namespace Elastica6\QueryBuilder\DSL;

use Elastica6\Aggregation\Avg;
use Elastica6\Aggregation\AvgBucket;
use Elastica6\Aggregation\BucketScript;
use Elastica6\Aggregation\Cardinality;
use Elastica6\Aggregation\DateHistogram;
use Elastica6\Aggregation\DateRange;
use Elastica6\Aggregation\ExtendedStats;
use Elastica6\Aggregation\Filter as FilterAggregation;
use Elastica6\Aggregation\Filters;
use Elastica6\Aggregation\GeoDistance;
use Elastica6\Aggregation\GeohashGrid;
use Elastica6\Aggregation\GlobalAggregation;
use Elastica6\Aggregation\Histogram;
use Elastica6\Aggregation\IpRange;
use Elastica6\Aggregation\Max;
use Elastica6\Aggregation\Min;
use Elastica6\Aggregation\Missing;
use Elastica6\Aggregation\Nested;
use Elastica6\Aggregation\Percentiles;
use Elastica6\Aggregation\PercentilesBucket;
use Elastica6\Aggregation\Range;
use Elastica6\Aggregation\ReverseNested;
use Elastica6\Aggregation\ScriptedMetric;
use Elastica6\Aggregation\SerialDiff;
use Elastica6\Aggregation\SignificantTerms;
use Elastica6\Aggregation\Stats;
use Elastica6\Aggregation\Sum;
use Elastica6\Aggregation\SumBucket;
use Elastica6\Aggregation\Terms;
use Elastica6\Aggregation\TopHits;
use Elastica6\Aggregation\ValueCount;
