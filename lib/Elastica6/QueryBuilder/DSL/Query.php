...
use Elastica6\Query\SpanNot;
use Elastica6\Query\SpanOr;
use Elastica6\Query\SpanTerm;
use Elastica6\Query\SpanWithin;
use Elastica6\Query\Term;
use Elastica6\Query\Terms;
...
class Query implements DSL
{
     ...
     *
     * @return \Elastica6\Query\MultiMatch
     */
     ...
     *
     * @return \Elastica6\Query\BoolQuery
     */
     ...
     *
     * @param null|\Elastica6\Query\AbstractQuery|array $filter
     *
     ...
     *
     * @param string|\Elastica6\Query|\Elastica6\Query\AbstractQuery $query
     ...
     * span first query.
     *
     * @param \Elastica6\Query\AbstractQuery|array $match
     * @param int                                     $end
     *
     * @return SpanFirst
     *
