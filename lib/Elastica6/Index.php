...
use Elastica6\Index\Settings as IndexSettings;
use Elastica6\Index\Stats as IndexStats;
...
class Index implements SearchableInterface
{
     ...
     *
     * @return \Elastica6\Index\Settings Settings object
     */
     ...
     *
     * @param \Elastica6\Query|string|array $query   Query object or array
     ...
     *
     * @return \Elastica6\Response Server response
     */
    ...
    /**
     * @param string|array|\Elastica6\Query $query
     ...
     *
     * @return \Elastica6\Client Index client object
     */
